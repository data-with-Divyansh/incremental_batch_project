...
day1df.coalesce(1).write.format("csv").mode("append").save("output/batch0")
...
day2df.coalesce(1).write.format("csv").mode("append").save("output/batch1")
...
day3df.coalesce(1).write.format("csv").mode("append").save("output/batch2")
